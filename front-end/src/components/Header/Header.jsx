...
const Header = () => {
  return (
    <header className="shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between sm:px4 px-8 py-4">
        ...
        <div className="flex items-center rounded-full border border-gray-300 py-2 pr-4 pl-6 shadow-md gap-2">
          ...
          <p className="sm:max-w-30 max-w-20 truncate">Jorge Nicolas</p>
        </div>
      </div>
    </header>
  );
